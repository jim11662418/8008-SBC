...
MANDELBROT: 
           mvi h,000             ; only mvi h,in this pgm; all data must reside on pg0 to fit in 1K 
           mvi l,(STARTY)&0FFH   ; Y1=STARTY 
           call FLOAD 
           mvi l,(Y1)&0FFH 
           call FSTORE 
           mvi l,(CNTY)&0FFH     ; CNTY = 21 
           mvi m,Y_N             ;025 
Y1LOOP:    mov a,m               ; print chr(64+CNTY) 
           adi 300 
           call ECHO 
...
FPZERO:    mvi l,126             ;Set L to point to MSW of FPACC 
...
FPCOMP:    mvi l,124             ; However, if original sign was negative, must now restore 
           mvi b,003             ;The FPACC to negative by performing two's complement 
